...
{
  "gitBranch" : "main",
  "gitUrl" : "https://github.com/fjb4/spring-sensors-rabbit.git",
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [https://github.com/tanzu-end-to-end/spring-sensors.git->https://github.com/f...(truncated), main->main]
